...
Note that the restriction to scalar values for the value of a mark will be lifted in the future, although mark values will never be mutable - instead you should always create a new mark when updating a value. For now, if you need complex values in a mark you should serialize the value to a string.
